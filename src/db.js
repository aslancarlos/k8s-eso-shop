  ...
  try {
    ...
    if (parseInt(rows[0].cnt) === 0) {
      await conn.execute(`
        ...
        ('Yoga Mat Premium', 'Non-slip 6mm thick yoga mat with carry strap', 49.99, 55, 'Sports', 'https://images.unsplash.com/photo-1518611012118-696072aa579a?w=400'),
    ...
    // Fix broken Unsplash URLs (photos removed from platform)
    const brokenImages = [
      ['https://images.unsplash.com/photo-1601925228046-38b3f28e2e42?w=400', 'https://images.unsplash.com/photo-1518611012118-696072aa579a?w=400'],
      ['https://images.unsplash.com/photo-1625480860249-be231806c8f7?w=400', 'https://images.unsplash.com/photo-1591488320449-011701bb6704?w=400'],
    ]
